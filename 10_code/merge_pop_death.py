...
file_path_population = r'C:\Users\19l20\Desktop\mids_study\pds_final_project\population.csv'
...
for year in years:
    ...
    merged_df[deaths_per_capita_column] = (
        merged_df[death_column] / merged_df[population_column]
...
# If you want to save the final dataset to a new CSV file, you can use the following line
final_df.to_csv(r'C:\Users\19l20\Desktop\mids_study\pds_final_project\final_dataset.csv', index=False)